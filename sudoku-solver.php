...
<head>
    ...
    <script defer src="sudoku-solver.js"></script>
</head>

<body>   
    <button type="button" style="width:200px;height:35px;" class="btn btn-danger" id="generate-sudoku">Get New Puzzle</button>
    <div id="container">
    ...
    <button type="button" style="width:200px;height:35px;" class="btn btn-success" id="solve">Solve</button>
</body>
</html>